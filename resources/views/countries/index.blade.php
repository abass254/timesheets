...
@section('content')
    ...
    <div class="">
        <h1 class="display-4">Countries of operation</h1>
        <hr />
    </div>
    ...
    <section id="data-list-view" class="data-list-view-header">
        ...
        <div class="table-responsive">
            <table class="table data-list-view">
                ...
                <tbody>
                    @foreach ($countries as $key => $td)
                        <tr>
                            <td id="dist_id_{{ $td->id }}" data-id="{{ $td->id }}" class="pl-4"
                                width="1">{{ $key + 1 }}</td>
                            <td width="9" class="text-primary font-weight-bold px-0">{{ strtoupper($td->ct_name) }}
                            </td>
                            <td>{{ $td->ct_desc }}</td>
                            <td>
                                <div width="1"
                                    class="badge badge-pill badge-{{ $td->ct_status == 1 ? 'success' : 'danger' }}">
        ...
        <div id="add-dist-modal" class="modal-content" aria-modal-class="">
            ...
            <form class="modal-body form-update-location">
                <input type="text" hidden class="form-control" name="_token" id="user_token"
                    value="{{ $token }}">
                <input type="text" hidden class="form-control" name="ct_id" id="ct-id">
                <div class="form-row">
                    <div class="col-md-12">
                        <div class="position-relative form-group">
                            <label for="patient-location">Country Name</label>
                            <div class="input-group">
                                <input required class="form-control form-control-sm patient-location" data-label="Address"
                                    id="ct-name" name="name" placeholder="Country Name" required="required"
                                    type="text" value="" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="position-relative form-group">
                            ...
                            <div class="input-group">
                                <textarea required name="desc" class="form-control form-control-sm validate bg-white pr-0" id="ct-desc"
                    ...
                    <div class="col-sm-12 status-field data-field-col">
                        ...
                        <select class="form-control" name="status" id="ct-status">
                ...
                <div class="modal-footer col-md-12">
                    ...
                    <button type="button" class="btn btn-danger btn-lg btn-save-country">Save</button>
                </div>
            </form>
        </div>
    </section>
